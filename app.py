...
def get_background(season):
    if season == "春":
        ...
        return "linear-gradient(120deg, #fff1e6 0%, #ffd6a5 50%, #ffad60 100%)"
    elif season == "冬":
...
comment_map = {
    ...
    ("spring", "men", "business"): "落ち着いたカラーでまとめたビジネスカジュアル。初対面でも好印象。参考ブランド（ユニクロ、GU、無印用品、スーツ店など）",
    ("spring", "women", "office"): "春のやわらかい空気にぴったりの軽やかコーデ。参考ブランド（ユニクロ、GU、GLOBAL WORKなど）",
    ("spring", "women", "business"): "春らしい抜け感で自然体に仕上がる着こなし。参考ブランド（ユニクロ、GU、スーツ店など）",
    ...
    ("autumn", "men", "office"): "深まりゆく季節に馴染む落ち着いた色味のオフィスカジュアル。",
    ("autumn", "men", "business"): "深みのある色合いでまとめたビジネスカジュアル。秋に映える落ち着いた着こなし。",
    ("autumn", "women", "office"): "落ち着きのある淡色で整える上品なオフィスカジュアル。",
    ("autumn", "women", "business"): "落ち着きのある色味で仕上げた上品で柔らかな印象に。",

    ("winter", "men", "office"): "上品に防寒するオフィスカジュアル。シルエットでスタイルアップ。",
    ("winter", "men", "business"): "引き締まった色味で知的な印象に。冬らしいシックなカラーがポイント。",
    ("winter", "women", "office"): "淡いカラーでまとめた冬のオフィススタイル。温かみのある印象に。",
